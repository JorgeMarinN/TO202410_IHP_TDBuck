...
df=pd.read_fwf('./data/data_CMOSVCOhv_v1p2_IHP.txt')
df.to_csv('./data/data_CMOSVCOhv_v1p2_IHP.csv', index=False)
data = pd.read_csv("./data/data_CMOSVCOhv_v1p2_IHP.csv").values
