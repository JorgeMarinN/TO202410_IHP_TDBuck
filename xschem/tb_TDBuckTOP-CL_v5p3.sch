...
vvdd vdd 0 dc 3.3
vvss vss 0 0
vvcontr VCONTr 0 dc 0.5
vvconts VCONTs 0 dc 0.51
*.option temp = 200
.ic v(VCONTs) = 0.45
.ic v(V_1s) = 0
.ic v(V_2s) = 3.3
...
C {devices/lab_wire.sym} 1555 -240 0 0 {name=l4 sig_type=std_logic lab=VDIG}
C {devices/lab_wire.sym} 1555 -650 0 0 {name=l11 sig_type=std_logic lab=VDIG}
C {devices/lab_pin.sym} 1925 -620 0 1 {name=l12 sig_type=std_logic lab=D1
}
C {devices/lab_wire.sym} 1885 -590 0 1 {name=l7 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} 3080 -160 2 0 {name=p28 sig_type=std_logic lab=VCONTs_out}
...
C {NOL_v2p1.sym} 2835 -1115 0 0 {name=x1}
...
device=resistor
m=1}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/LS_FINAL_IHP_v2.sym} 1735 -620 0 0 {name=x4}
C {devices/lab_wire.sym} 1885 -180 0 1 {name=l14 sig_type=std_logic lab=VSS}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/LS_FINAL_IHP_v2.sym} 1735 -210 0 0 {name=x11}
C {devices/lab_pin.sym} 1925 -210 0 1 {name=l13 sig_type=std_logic lab=D1_N
}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/Esm22_CMOSVCOlowG_v4p2_IHP.sym} 1590 -1270 0 0 {name=x5}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/Esm22_CMOSVCOlowG_v4p2_IHP.sym} 1590 -950 0 0 {name=x2}
C {sg13g2_stdcells/sg13g2_buf_4.sym} 1430 -210 0 0 {name=x6 VDD=VDIG VSS=VSS prefix=sg13g2_ }
...
C {devices/lab_wire.sym} 1905 -670 0 0 {name=l9 sig_type=std_logic lab=VDD_GD}
C {devices/lab_wire.sym} 1905 -260 0 0 {name=l10 sig_type=std_logic lab=VDD_GD}
