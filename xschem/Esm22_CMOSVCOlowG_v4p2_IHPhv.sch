...
C {stage_v2p1_IHPhv.sym} -310 -10 0 0 {name=x1}
C {stage_v2p1_IHPhv.sym} -120 -10 0 0 {name=x2}
C {stage_v2p1_IHPhv.sym} 70 -10 0 0 {name=x3}
C {stage_v2p1_IHPhv.sym} 260 -10 0 0 {name=x4}
C {stage_v2p1_IHPhv.sym} 450 -10 0 0 {name=x5}
