...
N 1390 -940 1420 -940 {
lab=V_2r}
N 1330 -1370 1330 -1340 {
lab=VDD}
N 1330 -1220 1330 -1190 {
lab=VSS}
N 1240 -1280 1270 -1280 {
lab=VCONTs}
N 1390 -1300 1485 -1300 {
lab=V_1s}
N 1390 -1260 1420 -1260 {
lab=V_2s}
N 2670 -420 2700 -420 {
lab=#net1}
N 2570 -420 2610 -420 {
...
.endc
"}
C {devices/lab_pin.sym} 1330 -1050 1 0 {name=p4 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1330 -870 3 0 {name=p5 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1240 -960 1 0 {name=p6 sig_type=std_logic lab=VCONTr}
C {devices/lab_pin.sym} 1410 -980 1 0 {name=p7 sig_type=std_logic lab=V_1r}
C {devices/lab_pin.sym} 1420 -940 1 0 {name=p1 sig_type=std_logic lab=V_2r}
C {devices/lab_pin.sym} 1330 -1370 1 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1330 -1190 3 0 {name=p3 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1240 -1280 1 0 {name=p8 sig_type=std_logic lab=VCONTs}
C {devices/lab_pin.sym} 1410 -1300 1 0 {name=p9 sig_type=std_logic lab=V_1s}
C {devices/lab_pin.sym} 1420 -1260 1 0 {name=p10 sig_type=std_logic lab=V_2s}
...
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/Esm22_CMOSVCOlowG_v6p4_IHP.sym} 1330 -1280 0 0 {name=x5}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/Esm22_CMOSVCOlowG_v6p4_IHP.sym} 1330 -960 0 0 {name=x2}
...
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 2125 -1130 1 0 {name=p26 sig_type=std_logic lab=VSS}
C {devices/capa.sym} 2125 -1390 2 0 {name=C2
m=1
value=100f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 2125 -1450 1 0 {name=p16 sig_type=std_logic lab=VSS}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/VCDLtop_v5p1.sym} 1555 -1290 0 0 {name=x11}
C {/home/designer/shared/TO202410_IHP_TDBuck/xschem/VCDLtop_v5p1.sym} 1555 -970 0 0 {name=x14}
...
C {devices/lab_pin.sym} 1485 -1280 3 0 {name=p19 sig_type=std_logic lab=VCONTr}
C {devices/lab_pin.sym} 1485 -960 3 0 {name=p22 sig_type=std_logic lab=VCONTr}
C {devices/lab_pin.sym} 1555 -1340 1 0 {name=p24 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1555 -1020 1 0 {name=p29 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1555 -1240 3 0 {name=p30 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1555 -920 3 0 {name=p32 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} 990 -930 0 0 {name=V2 value="pulse 0.6 0.9 75u 1u 1u 75u 150u"}
C {devices/lab_pin.sym} 990 -870 3 0 {name=p33 sig_type=std_logic lab=VSS}
