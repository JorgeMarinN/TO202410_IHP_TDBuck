...
C {vsource.sym} -760 -280 0 0 {name=Vdd value=\{Vdd\} savecurrent=false}
C {lab_pin.sym} -760 -340 0 0 {name=p5 sig_type=std_logic lab=Vdd}
C {gnd.sym} -760 -230 0 0 {name=l2 lab=GND}
C {lab_pin.sym} -760 -190 0 0 {name=p4 sig_type=std_logic lab=Vs_M1}
C {vsource.sym} -760 -130 0 1 {name=Vs value="PULSE(0 \{Vdd\} \{Del\} \{1n\} \{1n\} \{T*D\} \{T\} 0)" savecurrent=false}
C {gnd.sym} -760 -80 0 0 {name=l5 lab=GND}
...
"}
C {vsource.sym} -650 -280 0 0 {name=Vdd1 value=\{VH\} savecurrent=false}
C {lab_pin.sym} -650 -340 0 0 {name=p1 sig_type=std_logic lab=VH
value=\{VH\}}
...
C {vsource.sym} -650 -130 0 0 {name=Vg1 value="PULSE(0 \{Vdd\} \{TdR+Del\} \{1n\} \{1n\} \{T*D-TdR-TdF\} \{T\} 0)" savecurrent=false}
C {gnd.sym} -650 -80 0 0 {name=l8 lab=GND}
C {lab_pin.sym} -650 -190 0 0 {name=p14 sig_type=std_logic lab=Vs_M2}
...
C {lab_pin.sym} -180 -460 0 0 {name=p11 sig_type=std_logic lab=VH
value=\{VH\}}
C {lab_pin.sym} 150 -470 0 0 {name=p12 sig_type=std_logic lab=VH
value=\{VH\}}
