...
#/home/designer/shared/TO202410_IHP_TDBuck/xschem/data/data_TDBuckTOP-IHP-CL_v7p2_TEST.txt
df=pd.read_fwf('./data/data_TDBuckTOP-IHP-CL_v7p2_TEST.txt',infer_nrows = 1000)
df.to_csv('./data/data_TDBuckTOP-IHP-CL_v7p2_TEST.csv', index=False)
data = pd.read_csv("./data/data_TDBuckTOP-IHP-CL_v7p2_TEST.csv").values
...
#Data rows: 1757670 for t = 150us, dt = 100ps
#Vref = 1.2V
#i_cut = 250000
#num_rows_cut = 800000
#Vref = 1.8V
i_cut = 1050000
num_rows_cut = 1600000
