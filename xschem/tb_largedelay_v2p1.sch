...
C {large_delay_v1p1.sym} 230 -160 0 0 {name=x1}
...
"}
C {devices/lab_pin.sym} 640 -120 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 620 -200 0 0 {name=p12 sig_type=std_logic lab=VCC}
C {devices/lab_pin.sym} 760 -160 2 0 {name=p13 sig_type=std_logic lab=VOUT}
C {large_delay_v1p1.sym} 580 -160 0 0 {name=x2}
C {devices/lab_pin.sym} 430 -160 1 0 {name=p9 sig_type=std_logic lab=VOUT_1}
