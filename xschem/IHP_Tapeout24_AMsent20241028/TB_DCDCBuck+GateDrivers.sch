...
C {code_shown.sym} -1210 -310 0 0 {name=POWER_MOS_Parameters only_toplevel=false 
...
C {vsource.sym} -520 -410 0 1 {name=Vg2 value="PULSE(0 \{Vdd\} \{TdR\} \{TR\} \{TF\} \{T*D-TdR-TdF\} \{T\} 0)" savecurrent=false}
C {lab_pin.sym} -580 -550 0 1 {name=p6 sig_type=std_logic lab=Vs_M1}
C {gnd.sym} -580 -440 0 1 {name=l4 lab=GND}
C {vsource.sym} -580 -490 0 1 {name=Vg1 value="PULSE(0 \{Vdd\} 0 \{TR\} \{TF\} \{T*D\} \{T\} 0)" savecurrent=false}
...
C {devices/code.sym} -1440 -10 0 0 {name=Transient_simulation only_toplevel=false 
...
"}
C {ammeter.sym} -630 -350 0 0 {name=V_Igd_VH1 savecurrent=true spice_ignore=0}
C {ammeter.sym} -630 -100 0 0 {name=V_Igd_VH2 savecurrent=true spice_ignore=0}
C {ammeter.sym} -660 -100 0 1 {name=V_Igd_Vdd2 savecurrent=true spice_ignore=0}
C {ammeter.sym} -660 -350 0 1 {name=V_Igd_Vdd1 savecurrent=true spice_ignore=0}
C {DCDC_Buck_V2.sym} -270 -140 0 0 {name=X1}
C {/home/designer/shared/simulations/IHP-sg13g2/Simulaciones/IHP_Tapeout24/GateDriverV2.sym} -680 -210 0 0 {name=X2}
C {/home/designer/shared/simulations/IHP-sg13g2/Simulaciones/IHP_Tapeout24/GateDriverV2.sym} -680 40 0 0 {name=X3}
